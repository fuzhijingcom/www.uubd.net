...
class Dispatcher {
    ...
    static public function dispatch() {
        ...
        if( MODULE_NAME && (defined('BIND_MODULE') || !in_array_case(MODULE_NAME,C('MODULE_DENY_LIST')) ) && is_dir(APP_PATH.MODULE_NAME)){
            ...
            //加载模块权限检测文件
            if(is_file(MODULE_PATH.'Common/ACPopedom.class.php'))
                include MODULE_PATH.'Common/ACPopedom.class.php';
            //加载小区，物业，代理商三者关系检测文件
            if(is_file(APP_PATH.'Common/ACRelation.class.php'))
                include APP_PATH.'Common/ACRelation.class.php';
            //加载动态流模型处理类
            if(is_file(APP_PATH.'Common/DynamicModel.class.php'))
                include APP_PATH.'Common/DynamicModel.class.php';
            //加载动验证模型处理类
            if(is_file(APP_PATH.'Common/Validation.class.php'))
                include APP_PATH.'Common/Validation.class.php';
            // 加载模块的扩展配置文件
